    ...
    <header className="bg-gray-900 bg-opacity-100 text-white px-8">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">Get detailed insights about code quality, complexity, and potential issues.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-semibold mb-2">Contributor Metrics</h3>
              <p className="text-gray-600">Analyze contribution patterns, active developers, and team collaboration.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">Visual charts and graphs to better understand repository trends and patterns.</p>
            </div>
          </div>
        </div>
      </section>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <ol className="space-y-6">
                  <li className="flex items-start">
                    <span className="bg-blue-600 text-white rounded-full w-8 h-8 flex items-center justify-center mr-4 mt-1 flex-shrink-0">1</span>
                    <div>
                      <h4 className="font-semibold text-lg mb-1">Enter Repository URL</h4>
                      <p className="text-gray-600">Paste the URL of any public GitHub repository you want to analyze.</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="bg-blue-600 text-white rounded-full w-8 h-8 flex items-center justify-center mr-4 mt-1 flex-shrink-0">2</span>
                    <div>
                      <h4 className="font-semibold text-lg mb-1">Process Analysis</h4>
                      <p className="text-gray-600">Our system scans the repository, collects data, and processes analytics.</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="bg-blue-600 text-white rounded-full w-8 h-8 flex items-center justify-center mr-4 mt-1 flex-shrink-0">3</span>
                    <div>
                      <h4 className="font-semibold text-lg mb-1">Get Comprehensive Report</h4>
                      <p className="text-gray-600">View detailed insights and download reports for further analysis.</p>
                    </div>
                  </li>
                </ol>
              </div>
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Ready to gain insights into your repositories?</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">Start analyzing your GitHub repositories today and unlock valuable insights.</p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">Advanced GitHub repository analytics for developers and teams.</p>
            </div>
